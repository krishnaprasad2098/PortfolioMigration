...
const Footer = () => {
  return (
    <div>
      <div className="flex items-center justify-between px-10 pb-6 sm:py-2 gap-6 md:flex-row flex-col sm:gap-2">
        <h1 className="text-3xl px-3 md:text-2xl  font-bold py-2 sm:py-0 md:px-0 font-pilowlava">
          Krishna
        </h1>

        <ul className=" gap-6 px-1 items-center justify-evenly sm:justify-center flex-wrap flex sm:flex-row sm:gap-8">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-1 bg-purple-400 py-2">
        <div className="flex justify-center items-center gap-1">
          ...
          <p className="font-bold text-base font-sans text-black">
            2023. All rights reserved.S Krishna Prasad.
          </p>
        </div>
        <div className="flex justify-center items-center gap-1">
